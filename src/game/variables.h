...
MACRO_CONFIG_INT(SvFlag0HeatCap, sv_flag0_heat_cap, 5, 0, 10, CFGFLAG_SERVER, "Maximum heat which can be regenerated by the means of flag 0")
MACRO_CONFIG_INT(SvFlag1HeatCap, sv_flag1_heat_cap, 5, 0, 10, CFGFLAG_SERVER, "Maximum heat which can be regenerated by the means of flag 1")
MACRO_CONFIG_INT(SvTakeFlagSound, sv_take_flag_sound, 1, 0, 1, CFGFLAG_SERVER, "Enable (1) or disable (0) a sound when the flag is picked up or transfered")
